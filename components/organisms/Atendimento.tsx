export default function Atendimento() {
  const sectionActive =
    localStorage.getItem("activeSectionAtendimento") === "true" ? true : false;
          ...
          >
            <div id="informations" class="lg:w-[50%]">
              ...
              <p class="text-[20px] py-4">
                Nós adoraríamos poder atender em qualquer lugar, mas nossa van
                se limita ao Booklyn e Queens no momento.
              </p>
              <p class="text-[20px] py-4">
